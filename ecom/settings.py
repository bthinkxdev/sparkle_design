...
SITE_PHONE = config("SITE_PHONE", default="+91 8073119872")
SITE_WHATSAPP = config("SITE_WHATSAPP", default="+918073119872")  # No + or spaces for wa.me
SITE_EMAIL = config("SITE_EMAIL", default="info.sparkledesigns007@gmail.com")
SITE_INSTAGRAM = config("SITE_INSTAGRAM", default="designs_sparkling")  # Handle without @ for URLs
